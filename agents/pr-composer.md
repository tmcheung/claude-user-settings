...
6. Generate the formatted PR description following the strict template, make sure to not include irrelevant sections and headings. If updating an existing PR, use `gh pr edit <number> --body <description>`. If creating a new PR, use `gh pr create`.
